...
import PopupArranjo from "./PopupArranjo";
import PopupTPL from "./PopupTPL";
import PopupDesignacao from "./PopupDesignacao";
import PopupSaidas from "./PopupSaidas";
import PopupPartVM from "./PopupPartVM";
import PopupUsuarios from "./PopupUsuarios";
import PopupGrupos from "./PopupGrupos";
import PopupPubli from "./PopupPubli";
import PopupCong from "./PopupCong";
import PopupOradores from "./PopupOradores";
import PopupDiscursos from "./PopupDiscursos";
...
function HomePage() {
    ...
    return (
        <div>
            ...
            <div className="min-h-screen bg-slate-500 flex justify-center items-start">
                <div className="flex">
                    {/* <VerticalNavBar />  */}
                    <div className="max-w-4xl w-full mx-auto p-4 md:p-8 rounded-lg shadow-md grid grid-cols-1 md:grid-cols-2 gap-4">
